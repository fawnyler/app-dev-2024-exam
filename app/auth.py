...
class User(UserMixin):
    ...
    def is_admin(self):
        return self.role_id == current_app.config['ADMIN_ROLE_ID'] if current_user.is_authenticated else False

    def is_moderator(self):
        return self.role_id == current_app.config['MODERATOR_ROLE_ID'] if current_user.is_authenticated else False
